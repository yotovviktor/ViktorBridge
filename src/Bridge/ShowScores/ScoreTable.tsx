...
import { Entry, ScoreTableProps } from '../../model';
...
export const ScoreTable: React.FC<ScoreTableProps> = ({ onDelete, onEdit }) => {
    ...
    const [dialogEntry, setDialogEntry] = React.useState({} as Entry);
                ...
                <Table
                    ...
                    <TableBody>
                        ...
                        >
                            ...
                            <StyledTableCell align="right"></StyledTableCell>
                            <StyledTableCell align="right"></StyledTableCell>
                            {windowSize.width > 600 ? <StyledTableCell align="right"></StyledTableCell> : ''}                        </StyledTableRow>
                    </TableBody>
                </Table>
            </TableContainer>
            {
                showDialog ?
                    <EntryDetailsDialog entry={dialogEntry} calculateImpsTotalUpTo={calculateImpsTotalUpTo} calculateScoreTotalUpTo={calculateScoreTotalUpTo} close={closeDialog} onDeleteClick={onDelete} />
                    : ''
            }
        </>
    );
